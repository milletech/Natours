      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            // Reload the server not from the browser cache
            if (res.data.status = "success") {
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe("pk_test_51KdRnEBq1njwNNqlzzTnJKGAehqWGaSf25FqtxRuccuO6n4XCzpPuITewSGtICuVppDaKPoSlBFtgpPOpW0sSkxG00rCLtieSu");
            _context.prev = 1;
            _context.next = 4;
          ...
          case 4:
            ...
            console.log(session); // 2) Create checkout from and charge credit card
...
if (updateForm) {
  updateForm.addEventListener("submit", function (e) {
    e.preventDefault(); // Multi-part form data
